// S C R I P T  O R I  B Y  Bochilgaming & ImYanXiao🔭
// Ditulis Ulang Oleh Yuta Developer
// Jangan Dihapus Tqto Nya✨!
...
// kalo ga punya ketik "-" atau biarin aja biar ada creditsnya hehe:v
global.sig = 'https://instagram.com/yuta.developer' //Link Instagram lu
global.sgh = 'https://github.com/Nothing' //Link Github lu
global.sgc = 'https://chat.whatsapp.com/DGsqoceqpRuI5GsZVtnhax' // Grup Wa lu
global.sdc = '-' //Isi Pake Link Discord Lu Kalo Gada Biarin aja🗿
global.snh = 'https://nhentai.net/g/HaramTod🗿' //Hmmm, Ini boleh kalian isi terserah :v
global.gconlytext= '*Punten Euy*\nIni bot cuma bisa di grup\nNgak bisa di private chat\n*Biar GK delay, hehe*\nhttps://chat.whatsapp.com/Hj6gnwdbqztLjlbjXCtCT5\n_*Masuk ke grup ini yak, kalau mau main bot*_'
//gconlytext itu buat text yg mau dikirim pas mode grouponly
/*============== PAYMENT ==============*/
global.pdana = '081335334848' //Nomor Dana Lu
global.ppulsa = '081335334848' //Nomor SimCard Yang Lu Pake
global.psaweria = 'https://saweria.co/xinst' //Link Saweriamu Kalo Nggada Biarin :)

/*============== NOMOR ==============*/
global.nomorbot = '6281335334848' //Nomor Bot Lu
global.nomorown = '62838958681470' //Nomor Owner
global.namebot = 'Cute Bot' //Dilarang Menggunakan Nama Bot Yg Sama 🗿
global.nameown = 'Yuta - Dev' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['62838958681470', '❦ Yuta - Dev? 🎐', true] //Ganti jadi nomor lu sama Nama Lu
...
/*============== WATERMARK COY ==============*/
global.wm = 'WhatsApp Cute Bot Assistant' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Cute - Bot˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Cute Bot'
global.namedoc = 'Cute Bot Multi Device' //Main Name Menu Document
global.botdate = `⫹⫺ Day's: ${week} ${date}`
global.bottime = `Time's: ${wktuwib}`
global.titlebot = '🎋 Cute ┊ Rpg Bot WhatsApp'
global.author = global.wm

/*============== STICKER WM COY ==============*/
global.stickpack = 'Made By'
global.stickauth = `☂︎ Cute ✦\n\n⫹⫺ Whatsapp Bot\nwa.me/${global.nomorbot}`
global.packname = 'Sticker Request By '
global.packname2 = 'Created By Cute Bot'


/*============== TEXT ==============*/
global.wait = '```Loading, Please Wait...```'
global.eror = '```Error, Sorry!!```'
global.dtu = 'Instagram'
global.dtc = 'Call Owner'
global.phn = '+62 8389-5868-1470' // Isi Nomor Lu🗿
...
global.yutadev = ['https://telegra.ph/file/3748e869592e9882a8025.jpg',
'https://telegra.ph/file/52aaff75bf5c31d5b6a61.jpg',
'https://telegra.ph/file/79e9ef8827a3665f8148c.jpg',
'https://telegra.ph/file/f1cfc4ab082ef965ae1f9.jpg',
'https://telegra.ph/file/715e4e3b0ada5488b7b83.jpg',
'https://telegra.ph/file/dbebbb9081740cd911a21.jpg',
'https://telegra.ph/file/0c8080d1f2a45debc32b1.jpg',
'https://telegra.ph/file/1e35560eeaa8d0ab16ba0.jpg',
'https://telegra.ph/file/6cd3b76326343c2963416.jpg',
'https://telegra.ph/file/88012d7fd3d6e31e4887b.jpg']

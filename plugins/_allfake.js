		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://instagram.com/yuta.developer"			
				}
			}
		}
                global.flocation = {
...
function ucapan() {
	...
	let res = "Selamat Malam Kak 🌌"
	if(time >= 1) {
		res = "Pagi Pagi Bangun 🗿"
	}
	if(time >= 4) {
		res = "Selamat Pagi Kak, Hehe ⛅"
	}
	if(time > 10) {
		res = "Selamat Siang Kak, Hehe 🌅"
	}
	if(time >= 15) {
		res = "Selamat Sore Kak, Hehe 🌇"
	}
	if(time >= 18) {
